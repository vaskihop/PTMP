...
<div class="sidebar-sticky pt-3 bg-dark" style={{height: 100+"%"}}>
  ...
  <path d="M2.5 11h1v1h-1v-1zm2 0h1v1h-1v-1zm-2 2h1v1h-1v-1zm2 0h1v1h-1v-1zm6-10h1v1h-1V3zm2 0h1v1h-1V3zm-4 2h1v1h-1V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm-2 2h1v1h-1V7zm2 0h1v1h-1V7zm-4 0h1v1h-1V7zm0 2h1v1h-1V9zm2 0h1v1h-1V9zm2 0h1v1h-1V9zm-4 2h1v1h-1v-1zm2 0h1v1h-1v-1zm2 0h1v1h-1v-1z"/>
      ...
      <div class=" container jumbotron jumbotrons mt-3 py-5">
        ...
        <h1><b>PTMP</b></h1>
        <p class="lead"><b>This Program where you can add new projects and control
         them, also you have a list of tasks as you can control them too. PTMP similar to Jira. But you can use
          ...
          PTMP is a tool developed by VASKIHOP. It is used for bug tracking, issue tracking, and project management. Our project still in the
           process we are trying our best to improve more functionality and nice-looking design.</b></p>
